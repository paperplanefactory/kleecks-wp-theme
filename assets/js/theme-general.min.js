...
jQuery(".mega-menu-js")[0]&&(jQuery(".header-menu-js > .menu-item > a").not(".mega-menu-js-trigger").hover(function(a){jQuery(".mega-menu-js").addClass("hidden");jQuery(".mega-menu-js-trigger").removeClass("current-mega-menu")}),jQuery(".mega-menu-js-trigger").hover(function(a){jQuery(".mega-menu-js").addClass("hidden");jQuery(".mega-menu-js-trigger").removeClass("current-mega-menu");var b=jQuery(this).data("megamenu-open-id");jQuery(this).addClass("current-mega-menu");jQuery(b).removeClass("hidden");
a.preventDefault()}),jQuery(".mega-menu-js").mouseleave(function(a){jQuery(this).addClass("hidden");jQuery(".mega-menu-js-trigger").removeClass("current-mega-menu");a.preventDefault()}));jQuery(".overlay-menu-mobile-js > .menu-item-has-children > a").each(function(a,b){jQuery(this).append("<span>\u25bc</span>")});
jQuery(".overlay-menu-mobile-js > .menu-item-has-children > a > span").click(function(a){"\u25bc"==jQuery(this).text()?jQuery(this).text("\u25b2"):jQuery(this).text("\u25bc");jQuery(this).parent().parent().find(".sub-menu").slideToggle(150);a.preventDefault()});jQuery(".slide-double-js, .slide-single-js, .logos-slideshow-extended-js, .logos-slideshow-compact-js, .feature-image-slider-js, .slide-case-study-js, .slide-comunicato-stampa-js, .slide-foto-js").on("init reInit",function(a,b,c,d){AOS.refresh()});
jQuery(".logos-slideshow-compact-js").slick({lazyLoad:"progressive",dots:!1,focusOnSelect:!0,draggable:!0,infinite:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:4,slidesToScroll:4,arrows:!1,autoplay:!0,autoplaySpeed:2E3,responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});
jQuery(".logos-slideshow-extended-js").slick({lazyLoad:"progressive",dots:!1,focusOnSelect:!0,draggable:!0,infinite:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:6,slidesToScroll:6,arrows:!1,autoplay:!0,autoplaySpeed:2E3,responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});jQuery(".feature-image-slider-js").slick({lazyLoad:"progressive",dots:!1,focusOnSelect:!0,draggable:!0,infinite:!1,fade:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:1,slidesToScroll:1,arrows:!1});
jQuery(".slide-case-study-js, .slide-comunicato-stampa-js, .slide-foto-js").slick({lazyLoad:"progressive",dots:!0,focusOnSelect:!0,draggable:!0,infinite:!1,accessibility:!0,adaptiveHeight:!1,variableWidth:!0,slidesToShow:1,slidesToScroll:1,arrows:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});jQuery(document).on("keydown",function(a){37==a.keyCode&&jQuery(".slide-single-js").slick("slickPrev");39==a.keyCode&&jQuery(".slide-single-js").slick("slickNext")});
